...
namespace Gbg\Cake5Demo\Entity;

use Gbg\Cake5\Orm\Entity;

class Thing extends Entity
{
    protected ?string $virtualValueCache = null;

    // phpcs:disable PSR2.Methods.MethodDeclaration.Underscore -- CakePHP core syntax
    protected function _getValue(): string
    {
        return $this->virtualValueCache ?? '[not set yet]';
    }

    protected function _setValue(?string $value): void
    {
        $this->virtualValueCache = $value;
    }
    // phpcs: enable
}
